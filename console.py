#!/usr/bin/python3
"""The entry point to the HBnB console in AIRBNB PROJECT
Made by Anass El Hamdi Alaoui """
...
# All Support Commands:
    ...
    def do_show(self, model_key=None):
        ...
        Ex: $ show BaseModel 1234-5678-0910.
        """
        class_name = None
        model_id = None
        if model_key != "":
    ...
    def do_destroy(self, model_key=None):
        ...
        Ex: $ destroy BaseModel 1234-5678-0910.
        """
        class_name = None
        model_id = None
        if model_key != "":
    ...
    def do_update(self, model_info):
        ...
        Ex: $ update BaseModel 1234-5678-0910.
        email "anassalaoui0593@gmail.com"
        """
        model_type = None
        model_id = None
        model_attr = None
